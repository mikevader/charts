...
![Version: 6.6.28](https://img.shields.io/badge/Version-6.6.28-informational?style=flat-square) ![AppVersion: 1.0.5.2](https://img.shields.io/badge/AppVersion-1.0.5.2-informational?style=flat-square)
...
| sidecar.image.tag | string | `"1.27.0"` | nginx sidecar image tag |
