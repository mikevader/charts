...
![Version: 2.0.3](https://img.shields.io/badge/Version-2.0.3-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: version-5.6.14](https://img.shields.io/badge/AppVersion-version--5.6.14-informational?style=flat-square)
...
|------------|------|---------|
| https://charts.bitnami.com/bitnami | mariadb | 12.1.6 |
...
| cronjobs.recurring.image.tag | string | `"8.00.1"` |  |
