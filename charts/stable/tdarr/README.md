...
![Version: 4.10.0](https://img.shields.io/badge/Version-4.10.0-informational?style=flat-square) ![AppVersion: 2.86.01](https://img.shields.io/badge/AppVersion-2.86.01-informational?style=flat-square)
...
| node.image.tag | string | `"2.86.01"` | image tag |
