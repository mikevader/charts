...
![Version: 1.0.0](https://img.shields.io/badge/Version-1.0.0-informational?style=flat-square) ![AppVersion: 1.33.2](https://img.shields.io/badge/AppVersion-1.33.2-informational?style=flat-square)
...
helm repo update
helm install overseerr mikevader/overseerr
```
...
```console
helm install overseerr mikevader/overseerr -f values.yaml
```
