...
**This chart is not maintained by the upstream project and any issues with the chart should be raised [here](https://github.com/mikevader/charts/issues/new/choose)**
...
helm repo update
helm install plex mikevader/plex
```
...
Other values may be used from the [values.yaml](https://github.com/mikevader/charts/tree/main/charts/library/common/values.yaml) from the [common library](https://github.com/mikevader/charts/tree/main/charts/library/common).
...
```console
helm install plex mikevader/plex -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/mikevader/plex?modal=changelog)
