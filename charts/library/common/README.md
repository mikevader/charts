...
![Version: 4.5.35](https://img.shields.io/badge/Version-4.5.35-informational?style=flat-square) ![Type: library](https://img.shields.io/badge/Type-library-informational?style=flat-square)
...
| addons.promtail.image.tag | string | `"3.0.0"` | Specify the promtail image tag |
