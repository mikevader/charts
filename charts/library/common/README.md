...
![Version: 4.8.0](https://img.shields.io/badge/Version-4.8.0-informational?style=flat-square) ![Type: library](https://img.shields.io/badge/Type-library-informational?style=flat-square)
...
| addons.promtail.image.tag | string | `"3.6.2"` | Specify the promtail image tag |
