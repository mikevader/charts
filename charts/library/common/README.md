...
![Version: 4.9.1](https://img.shields.io/badge/Version-4.9.1-informational?style=flat-square) ![Type: library](https://img.shields.io/badge/Type-library-informational?style=flat-square)
...
| addons.codeserver.image.tag | string | `"4.123.0"` | Specify the code-server image tag |
...
| addons.netshoot.image.tag | string | `"v0.16"` | Specify the netshoot image tag |
...
| addons.promtail.image.tag | string | `"3.6.11"` | Specify the promtail image tag |
...
| addons.vpn.gluetun.image.tag | string | `"v3.41.1"` | Specify the Gluetun image tag |
