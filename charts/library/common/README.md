...
![Version: 4.5.26](https://img.shields.io/badge/Version-4.5.26-informational?style=flat-square) ![Type: library](https://img.shields.io/badge/Type-library-informational?style=flat-square)
...
| addons.codeserver.image.tag | string | `"4.19.1"` | Specify the code-server image tag |
