...
![Version: 4.5.18](https://img.shields.io/badge/Version-4.5.18-informational?style=flat-square) ![Type: library](https://img.shields.io/badge/Type-library-informational?style=flat-square)
...
| addons.codeserver.image.tag | string | `"4.15.0"` | Specify the code-server image tag |
...
| addons.vpn.gluetun.image.tag | string | `"v3.35.0"` | Specify the Gluetun image tag |
