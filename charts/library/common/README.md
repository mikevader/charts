...
![Version: 4.5.28](https://img.shields.io/badge/Version-4.5.28-informational?style=flat-square) ![Type: library](https://img.shields.io/badge/Type-library-informational?style=flat-square)
...
| addons.promtail.image.tag | string | `"2.9.3"` | Specify the promtail image tag |
